...
links1 = [text1]
test=[]
for OptionOne1 in links1:
    try:
        #try to load the wikipedia page
        page=wikipedia.page(OptionOne1, auto_suggest=False)
        test.append(page)
...
links2 = [text2]
test=[]
for OptionTwo2 in links2:
    try:
        #try to load the wikipedia page
        page=wikipedia.page(OptionTwo2, auto_suggest=False)
        test.append(page)
    except wikipedia.exceptions.PageError:
        #if a "PageError" was raised, ignore it and continue to next link
        continue
...
links3 = [text3]
test=[]
for OptionThree3 in links3:
    try:
        #try to load the wikipedia page
        page=wikipedia.page(OptionThree3, auto_suggest=False)
        test.append(page)
    except wikipedia.exceptions.PageError:
        #if a "PageError" was raised, ignore it and continue to next link
        continue
